...
#topCorners = [[1,2,4],[1,3,2],[1,5,3],[1,4,5]]
#bottomCorners = [[6,4,2],[6,2,3],[6,3,5],[6,4,5]]
#topEdges = [[1,2],[1,3],[1,5],[1,4]]
#frontEdges = [[2,4],[2,3]] backEdges = [[5,3],[5,4]]
#underEdges = [[6,2],[6,3],[6,5],[6,4]]

corners = [[1,2,5],[1,3,2],[1,4,3],[1,5,4],[6,5,2],[6,2,3],[6,3,4],[6,4,5]]
edges = [[1,2],[1,3],[1,4],[1,5],[6,2],[6,3],[6,4],[6,5],[2,5],[2,3],[4,3],[4,5]]
...
for i in range(30):
    rotateSide(random.randint(1,6),random.randint(1,3))
...
#the first rotation of an algorithm might cancel the last rotation of the previous algorithm, unnecessary rotations are removed
#if two succesive moves rotate the same side they are merged into one rotation
...
#print newCommands        
print "Cube solved in " + str(len(newCommands)) + " moves"
print newCommands
